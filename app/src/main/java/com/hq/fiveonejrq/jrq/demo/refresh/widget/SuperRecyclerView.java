...
import com.hq.fiveonejrq.jrq.demo.refresh.interfaces.AppBarStateChangeListener;

public class SuperRecyclerView extends RecyclerView {
    private boolean isLoadingData = false;
    private boolean isNoMore = false;
    private int mRefreshProgressStyle = ArrowRefreshHeader.ProgressStyle.SysProgress;
    private int mLoadingMoreProgressStyle = ArrowRefreshHeader.ProgressStyle.SysProgress;
